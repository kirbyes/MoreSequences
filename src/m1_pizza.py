...
def run_test_draw_points_on_circle():
    ...
    # Test 4:
    title = 'DRAW_POINTS_ON_CIRCLE, test 2:  4 red dots.'
    window = rg.RoseWindow(500, 500, title)
    circle = rg.Circle(rg.Point(150, 200), 150)
...
def run_test_pizza():
    ...
    # Test 4:
    title = 'PIZZA test 4:  40 slices, thin (thickness=1) black lines.'
    window = rg.RoseWindow(500, 500, title)
    circle = rg.Circle(rg.Point(300, 300), 150)
    circle.outline_thickness = 3
    circle.fill_color = 'yellow'
    pizza(window, circle, 500, 'black', 1)
    window.close_on_mouse_click()
...
def run_test_polygon():
    ...
    # Tests 3
    title = 'POLYGON tests 3:  9 segments with thin green lines.'
    window = rg.RoseWindow(550, 400, title)

    circle = rg.Circle(rg.Point(375, 125), 80)
    circle.outline_thickness = 1
    polygon(window, circle, 9, 'green', 3)
    window.close_on_mouse_click()
...
def run_test_fancy_polygon():
    ...
    title = 'FANCY POLYGON test 4:  12 red lines on yellow circle, hops = 4.'
    window = rg.RoseWindow(480, 350, title)

    circle = rg.Circle(rg.Point(320, 170), 150)
    circle.fill_color = 'yellow'
    fancy_polygon(window, circle, 12, 4, 'red', 2)
    window.close_on_mouse_click()
